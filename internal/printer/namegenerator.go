...
type NameGenerator struct {
	...
	nodeToGeneratedName                map[*ast.Node]string      // Map of generated names for specific nodes
	nodeToGeneratedPrivateName         map[*ast.Node]string      // Map of generated private names for specific nodes
...
func (g *NameGenerator) generateNameForNodeCached(node *ast.Node, privateName bool, flags GeneratedIdentifierFlags, prefix string, suffix string) string {
	cache := core.IfElse(privateName, &g.nodeToGeneratedPrivateName, &g.nodeToGeneratedName)
	if *cache == nil {
