...
type ContainingSymbolLinks struct {
	extendedContainersByFile map[*ast.SourceFile][]*ast.Symbol // Symbols of nodes which which logically contain this one, cached by file the request is made within
